...
<?php
  ...
  if(isset($_POST['save']))
  {
    ...
    $phone1=$_POST['Phone1'];
  	...
  	$query1="INSERT INTO Police (Police_ID,Police_Name,Police_Station,Gender,Phone_num,Police_Email,Address,City,Police_Username,Password) VALUES ('$Police_ID','$Police_Name', '$Police_Station','$Gender','$phone1','$Police_Email','$Address','$City','$Login_Username','$Password')";
