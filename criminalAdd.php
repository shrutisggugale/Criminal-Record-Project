...
<?php
  ...
  if(isset($_POST['Next']))
  {
    ...
    $Height = $_POST['Hnumber'];
  	...
  	$query1="INSERT INTO Criminal (Criminal_ID,criminal_img,Criminal_name,Address,State,Country,Pincode,Height,Weight) VALUES ('$Criminal_ID','$folder', ' $Criminal_Name','$Address','$State','$Country','$pin_code','$Height','$Weight')";
