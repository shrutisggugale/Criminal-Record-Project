...
<body>
  <form method="post">
    <div class="container">
      ...
      <input type="text" name="ID" placeholder="Enter FIR ID" size="15" required >
...
<?php
  ...
  if(isset($_POST['save']))
  {
  	...
  	$query1="INSERT INTO fir (FIR_ID , FIR_Status,FIR_Description, date_reported) VALUES ('$FIR_ID','$FIR_Status','$Description','$Date')";
