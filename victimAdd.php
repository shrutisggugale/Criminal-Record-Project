...
<?php
  ...
  if(isset($_POST['save']))
  {
    ...
    $Vpin_code = $_POST['VPnumber'];
  	...
  	$query1="INSERT INTO Victim (Victim_ID,Victim_Name,crime_ID,National_ID, Victim_Birthdate, Address,State,Country,Pincode) VALUES ('$Victim_ID', ' $Victim_Name','$crime_ID','$National_ID','$Victim_Birthdate','$VAddress','$VState','$VCountry','$Vpin_code')";
