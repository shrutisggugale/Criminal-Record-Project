...
<body>
  <form method="post">
    <div class="container">
      ...
      <input type="text" name="ID" placeholder="Admin ID" value="<?php echo $result['Admin_ID']; ?> " required >
...
<?php
  ...
  if(isset($_POST['save']))
  {
    ...
    $query2="Update Admin set Admin_ID='$Admin_ID',Admin_Name='$Admin_Name', Admin_Username='$Username', Password='$Password', Admin_Email='$emailId', Admin_Address='$address', city='$city' where Admin_ID='$id'";
