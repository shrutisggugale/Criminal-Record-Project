...
<body>
  <form method="post">
    <div class="container">
      ...
      <input type="text" name="ID" placeholder="Enter Police ID" value="<?php echo $result['Judge_ID']; ?> " required >
...
<?php
  ...
  if(isset($_POST['save']))
  {
    ...
    $query2="Update Judge set Judge_ID='$Judge_ID',Judge_Name='$Judge_Name',Court='$Court' where Judge_ID='$id'";
