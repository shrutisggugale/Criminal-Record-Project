...
<body>
  <form method="post">
    <div class="container">
      ...
      <input type="text" name="ID" placeholder="Enter Victim ID" value="<?php echo $result['Victim_ID']; ?> " required >
...
<?php
  ...
  if(isset($_POST['save']))
  {
    ...
    $query2="UPDATE Victim set Victim_ID='$Victim_ID',Victim_Name='$Victim_Name', National_ID='$National_ID', address='$address', State='$State',Country = '$Country',Pincode='$Pincode' where Victim_ID='$id'";
