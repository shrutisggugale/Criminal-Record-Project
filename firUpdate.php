...
<body>
  <form method="post">
    <div class="container">
      ...
      <input type="text" name="ID" placeholder="Enter FIR ID" value="<?php echo $result['FIR_ID']; ?>" required >
...
<?php
  ...
  if(isset($_POST['save']))
  {
    ...
    $query2="UPDATE FIR set FIR_ID='$FIR_ID',FIR_Status='$FIR_Status', FIR_Description='$FIR_Description' where FIR_ID='$FIR_ID'";
